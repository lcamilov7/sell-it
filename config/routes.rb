Rails.application.routes.draw do
  ...
  resources :favorites, only: %i[create destroy], param: :product_id # Asi el param id de siempre pasara a llamarse product_id es mejor y se entiende mejor, en el controlador de favorites buscaremos product por el param pasado al invocar un metodo del controlador favorites y el param será llamado product_id porq aca lo definimos asi, id es de default pero le cambiamos el nombre a product_id
